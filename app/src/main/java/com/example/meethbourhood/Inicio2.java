...
public class Inicio2 extends AppCompatActivity {
    ...
    public void verificacionInicioSesion(){
        if(firebaseUser != null){
            CargarDatos();
            Toast.makeText(Inicio2.this, "Se ha iniciado sesión", Toast.LENGTH_SHORT).show();
        } else{
    ...
    public void CerrarS(View view){
        ...
        Toast.makeText(Inicio2.this, "Ha cerrado sesión", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Inicio2.this, MainActivity.class));
    }

    //MÉTODO PARA RECUPERAR LOS DATOS DE FIREBASE, DEL USUARIO ACTUAL
